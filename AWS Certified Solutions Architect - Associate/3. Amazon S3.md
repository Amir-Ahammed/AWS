...
- **Additional Replications Settings**
  - **Multi-Destination Replication**: Replicates from one source bucket to *multiple* destination buckets.
  - **S3 Replication Time Control (RTC)**: Replication Time Control replicates 99.99% of new objects within 15 minutes and includes replication metrics.
  ...
  - **Replication metrics:** With replication metrics, you can monitor the total number and size of objects that are pending replication, and the maximum replication time to the destination Region. You can also view and diagnose replication failures.
...
<details>
  <summary><h4>Why to use?</h4></summary>
...
<details>
  <summary><h4>Types of Replication</h4></summary>
...
<details>
  <summary><h5>Types of Live Replication</h5></summary>
...
<details>
  <summary><h4>Additional Replication Settings</h4></summary>
...
<details>
  <summary><h4>Additional Note</h4></summary>
